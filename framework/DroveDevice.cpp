...
namespace Drove {
    bool Device::isDeviceSuitable(VkPhysicalDevice device, VkSurfaceKHR* pSurface) {
        QueueFamilyIndices indices = findQueueFamilies(device, pSurface);
    ...
    QueueFamilyIndices Device::findQueueFamilies(VkPhysicalDevice device, VkSurfaceKHR* pSurface) {
    ...
    SwapChainSupportDetails Device::querySwapChainSupport(VkPhysicalDevice device, VkSurfaceKHR* pSurface) {
    ...
    void Device::pickPhysicalDevice(VkInstance* pInstance, VkSurfaceKHR* pSurface) {
    ...
    void Device::createLogicalDevice(VkSurfaceKHR* pSurface) {
	...
	Device::Device(VkInstance* pInstance, VkSurfaceKHR* pSurface) {
        pickPhysicalDevice(pInstance, pSurface);
